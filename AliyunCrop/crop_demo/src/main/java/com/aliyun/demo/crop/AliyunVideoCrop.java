...
public class AliyunVideoCrop extends Activity implements TextureView.SurfaceTextureListener,
    ...
    MediaPlayer.OnVideoSizeChangedListener, VideoTrimFrameLayout.OnVideoScrollCallBack, View.OnClickListener,
    CropCallback, Handler.Callback {
    ...
    private void getData() {
        ...
        resolutionMode = getIntent().getIntExtra(AliyunSnapVideoParam.VIDEO_RESOLUTION,
