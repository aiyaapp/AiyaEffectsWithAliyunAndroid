...
//        };
    ...
    private void initView(){
        ...
        mResolutionBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                }else if(progress <= PROGRESS_480P){
    ...
    public void onClick(View v) {
        if(v == mStartRecordTxt){
            ...
            if (min >= max) {
                Toast.makeText(this, getResources().getString(R.string.aliyun_recoder_duration_error), Toast.LENGTH_SHORT).show();
                return;
            }
