...
//        if(mIsInvert)
//        {
//            mTailView = new TimelineOverlayHandleView(mOverlayView.getTailView(), mDuration + startTime);
//            mHeadView = new TimelineOverlayHandleView(mOverlayView.getHeadView(), startTime);
//        }else{
...
//            }
    ...
    public void requestLayout() {
        ...
        int margin;
        if(mIsInvert){
            margin = layoutParams.rightMargin = mTimelineBar.calculateTailViewInvertPosition(mTailView);
        }else{
            margin = layoutParams.leftMargin = mTimelineBar.calculateTailViewPosition(mTailView);
        }
        mTailView.getView().setLayoutParams(layoutParams);

        Log.d(TimelineBar.TAG, "TailView Margin = "+ margin + "timeline over" + this);
//        Log.d(TimelineBar.TAG, "TailView X = "+mTailView.getView().getX());
