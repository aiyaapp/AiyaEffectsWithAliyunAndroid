...
//        if(!isTextOnly && mLayout != null && mMaxLines != 1){
...
//            return null;
//        }
//        float scaleFactor = w * 1.0f / bmpWidth;
//
//        int startSize = (int) mMinTextSize;
//        float maxTextSize = 0;
//        if (isEditCompleted) {
...
//        paint.setTextSize(
//                efficientTextSizeSearch(startSize, (int) maxTextSize,
//                        mSizeTester, new RectF(0, 0, bmpWidth, bmpHeight)));
//        StaticLayout scaledLayout = null;
//        CharSequence charSeq = getText();
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
//            scaledLayout = StaticLayout.Builder.obtain(
//                    charSeq,
//                    0,
//                    charSeq.length(),
//                    paint,
//                    w).setAlignment(Layout.Alignment.ALIGN_CENTER)
//                    .build();
//        } else {
//            scaledLayout = new StaticLayout(charSeq, paint, w, Layout.Alignment.ALIGN_CENTER, mSpacingMult,
//                    mSpacingAdd, false);
//        }
//
//        Bitmap textBmp = Bitmap.createBitmap(bmpWidth, bmpHeight, Bitmap.Config.ARGB_8888);
//        Canvas canvas = new Canvas(textBmp);
//        canvas.translate((w - rw) / (2 * scaleFactor), (h - rh) / (2 * scaleFactor));
//
//        if (mCurrentStrokeColor != null && mCurrentStrokeColor != 0) {
//            paint.setStyle(Paint.Style.STROKE);
//            paint.setStrokeJoin(mStrokeJoin);
