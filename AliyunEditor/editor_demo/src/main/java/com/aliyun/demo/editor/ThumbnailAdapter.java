...
public class ThumbnailAdapter extends RecyclerView.Adapter<ThumbnailAdapter.ThumbnailViewHolder> {
    ...
    public ThumbnailAdapter(int count, AliyunIThumbnailFetcher fetcher, int screenWidth, int thumbnailWidth, int thumbnailHeight) {
        this.mFetcher = fetcher;
        this.mCount = count;
        this.mScreenWidth = screenWidth;
        mFetcher.setParameters(thumbnailWidth, thumbnailHeight, AliyunIThumbnailFetcher.CropMode.Mediate, ScaleMode.LB, 30);
    }
