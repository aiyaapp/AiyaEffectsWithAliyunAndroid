...
public class VideoTrimAdapter extends BaseAdapter {
    ...
    public int getCurrentLeftItem(int left) {
        ...
        if (!"0".equals(intStr) && !"0".equals(pointStr)) {
...
//        return (int) Math.round(count);
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate( R.layout.aliyun_svideo_import_item_qupai_trim_video_thumbnail, parent, false);
